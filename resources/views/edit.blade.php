...
<div class="create-wrapper">
  ...
  @endif
    <div class="create-form__name-div">
      ...
      <input type="text" class="create-form__name-inp create-form-inp" id="meal-name" name="name"  value="{{$meal->name}}">
    ...
    <div class="create-form__cost-div">
      ...
      <input type="number" class="create-form__cost-int create-form-inp" id="meal-cost" min="0" name="cost" value="{{$meal->cost}}">
    ...
    <div class="create-form__ingredient-div">
      ...
      <textarea class="create-form__ingredient-text create-form-inp" id="meal-ingredient" name="ingredient"cols="30" rows="10">{{$meal->ingredient}}</textarea>
    ...
    <div class="create-form__way-div">
      ...
      <textarea class="create-form__way-text create-form-inp" id="meal-way" name="way"cols="30" rows="10">{{$meal->way}}</textarea>
